...
public class PostController {
    ...
    public ResponseEntity<ApiResponse<PaginatedResponse<PostDTO>>> getAllPost(
        ...
        return ResponseEntity.status(HttpStatus.OK)
                .body(ApiResponse.success(postService.getAllPost(page, size, searchKey), "success"));
    }
    ...
    public ResponseEntity<ApiResponse<List<PostDTO>>> findTop5MostPopularPosts(
            ...
            @RequestParam(defaultValue = "10") int size) {
        return ResponseEntity.status(HttpStatus.OK)
                .body(ApiResponse.success(postService.findTop5MostPopularPosts(page, size), "success"));
    }
    ...
    public PaginatedResponse<PostSearchResult> searchPosts(
