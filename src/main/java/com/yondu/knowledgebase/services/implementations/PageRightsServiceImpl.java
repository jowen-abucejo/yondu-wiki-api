...
public class PageRightsServiceImpl implements PageRightsService {
     ...
     *
     * fetch all pages that a user can access (sort by view, edit access, review access)
     * fetch all pages that a usergroup can access (sort by view, edit access, review access)
...
//        Permission permission = permissionRepository.findById(requiredPermission).orElseThrow(()-> new ResourceNotFoundException("Page Permission not found with ID: "+ requiredPermission));
//
