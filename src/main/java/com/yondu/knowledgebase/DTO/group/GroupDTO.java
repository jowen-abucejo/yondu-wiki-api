...
public class GroupDTO {
    public record BaseResponse(Long id, String name, String description, LocalDateTime dateCreated, LocalDateTime dateModified, UserDTO.GeneralResponse createdBy, Boolean is_active, Set<UserDTO.GeneralResponse> users) {}
