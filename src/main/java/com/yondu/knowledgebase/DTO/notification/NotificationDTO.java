...
public class NotificationDTO {
    ...
    public record BaseResponse(long id, UserDTO.GeneralResponse user, UserDTO.GeneralResponse fromUser, String message, LocalDateTime timestamp, boolean isRead, String type, long typeId) {}
}
